...
U_B, U_B_err = pogg.poggendorf(poggendorf[0], poggendorf[1], poggendorfp_err)
...
R2_x, R2_x_err = wheat.wheatstone_R(150, 1.5, wheatstone_R2[0], wheatstone_R2[1], wheatstone_R2p_err)
...
R5_x, R5_x_err = wheat.wheatstone_R(150, 1.5, wheatstone_R5[0], wheatstone_R5[1], wheatstone_R5p_err)
...
C1_x, C1_x_err = wheat.wheatstone_C(476e-9, 4.76e-9, wheatstone_C1[0], wheatstone_C1[1], wheatstone_C1p_err)
...
RC1C_x, RC1C_x_err = wheat.wheatstone_C(476e-9, 4.76e-9, wheatstone_RC1[0], wheatstone_RC1[1], wheatstone_RC1p_err)
...
RC1R_x, RC1R_x_err = wheat.wheatstone_R(160, 1.6, wheatstone_RC1[0], wheatstone_RC1[1], wheatstone_RC1p_err)
