...
R2_x, R2_x_err = wheat.wheatstone(150, 1.5, wheatstone_R2[0], wheatstone_R2[1], wheatstone_R2_err)
print(R2_x, R2_x_err)
...
R5_x, R5_x_err = wheat.wheatstone(150, 1.5, wheatstone_R5[0], wheatstone_R5[1], wheatstone_R5_err)
print(R5_x, R5_x_err)
...
C1_x, C1_x_err = wheat.wheatstone(476e-9, 4.76e-9, wheatstone_C1[0], wheatstone_C1[1], wheatstone_C1_err)
print(C1_x, C1_x_err)
...
RC1C_x, RC1C_x_err = wheat.wheatstone(476e-9, 4.76e-9, wheatstone_RC1[0], wheatstone_RC1[1], wheatstone_RC1_err)
...
RC1R_x, RC1R_x_err = wheat.wheatstone(160, 1.6, wheatstone_RC1[0], wheatstone_RC1[1], wheatstone_RC1_err)
