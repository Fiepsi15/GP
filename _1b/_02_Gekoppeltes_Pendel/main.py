...
print(arr)
print(arr_err)
array_to_tex.array_to_tex(np.array([arr]), np.array([arr_err]), [["$I$"], ["$\\text{kgm}^2$"]], "Trägheitsmomente der Einzelkomponenten", "traegheitsmomente_einzelkomponenten")
array_to_tex.array_to_tex(np.array([[L_K, L_K-4e-2, L_K-8e-2], I_Federmontur]), [[dL for _ in range(3)], I_Federmontur_err], [["$L_K$", "$I$"], ["m", "$\\text{kgm}^2$"]], "Trägheitsmomente der Kopplungsmontur bei verschiedenen Kopplungslängen.", "trägheitsmomente_kopplungsmontur")
