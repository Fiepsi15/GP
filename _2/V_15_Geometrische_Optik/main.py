...
_ = abb.calculate_f(g1, b1, name="f1")
...
f, df = abb.calculate_f(g2, b2, name="f2")
...
_ = bess.calculate_f(d1, a, dd=delta_d, da=delta_a, name="f1")
...
f, df = bess.calculate_f(d2, a, dd=delta_d, da=delta_a, name="f2")
d, dd = abb.calculate_d(60, -150, f * 1e3, df * 1e3)
